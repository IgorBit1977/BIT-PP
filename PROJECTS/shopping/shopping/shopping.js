(function execution() {
  ...
  var banana = new Product("Banana", 263.99, "2018,12,8");
  var hleb = new Product("Hleb", 165.0, "2018,12,5");
  var deterdzent = new Product("Deterdzent", 138.9, "2019,1,1");

  var shoppingBag1 = new ShoppingBag();
  var visa = new PaymentCard(400, "2018, 1, 1");
